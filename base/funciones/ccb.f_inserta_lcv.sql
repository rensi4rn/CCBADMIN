create function f_inserta_lcv(p_administrador integer, p_id_usuario integer, p_tabla character varying, p_id_movimiento integer) returns character varying
    language plpgsql
as
$$
/*
...
alter function f_inserta_lcv(integer, integer, varchar, integer) owner to postgres;
