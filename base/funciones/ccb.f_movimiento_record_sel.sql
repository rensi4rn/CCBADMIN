create function f_movimiento_record_sel(p_administrador integer, p_id_usuario integer, p_tabla character varying, p_transaccion character varying) returns SETOF record
    language plpgsql
as
$$
DECLARE
...
BEGIN
	...
	***********************************/
    ...
    ELSEIF(p_transaccion='CCB_MOVRESDET_REP')then
        ...
        --raise exception ' %  ', va_id_regiones;
...
alter function f_movimiento_record_sel(integer, integer, varchar, varchar) owner to postgres;
