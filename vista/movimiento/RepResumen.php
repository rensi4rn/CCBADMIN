...
?>
<script>
Phx.vista.RepResumen=Ext.extend(Phx.frmInterfaz,{
    ...
    {   
        ...
        Phx.vista.RepResumen.superclass.constructor.call(this,config);
        this.init(); 
    ...
    onSubmit: function(o) {
    	...
    	if (me.form.getForm().isValid()) {
			 ...
			 Ext.Ajax.request({
				...
				url: '../../sis_admin/control/Movimiento/reporteResumen',
				params:  parametros,
