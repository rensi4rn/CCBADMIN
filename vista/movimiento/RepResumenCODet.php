...
?>
<script>
Phx.vista.RepResumenCODet=Ext.extend(Phx.frmInterfaz,{
    ...
    {   
        ...
        Phx.vista.RepResumenCODet.superclass.constructor.call(this,config);
        this.init(); 
    ...
    onSubmit: function(o) {
    	...
    	if (me.form.getForm().isValid()) {
			 ...
			 Ext.Ajax.request({
				...
				url: '../../sis_admin/control/Movimiento/reporteResumenCO',
				params:  parametros,
