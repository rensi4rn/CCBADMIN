...
<script>
Phx.vista.RepEgresos=Ext.extend(Phx.frmInterfaz,{
    ...
    {   
        ...
        Phx.vista.RepEgresos.superclass.constructor.call(this,config);
        this.init(); 
        this.iniciarEventos();   
    ...
    onSubmit: function(o) {
    	...
    	if (me.form.getForm().isValid()) {
			 ...
			 Ext.Ajax.request({
				...
				url:'../../sis_admin/control/Movimiento/reporteEgresos',
				params: parametros,
