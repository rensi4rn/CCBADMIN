...
<script>
Phx.vista.ComprobanteOfrendas=Ext.extend(Phx.frmInterfaz,{
    ...
    {   
        ...
        Phx.vista.ComprobanteOfrendas.superclass.constructor.call(this,config);
        this.init(); 
        this.iniciarEventos();   
    ...
    Atributos:[
		...
		},
		{
			config:{
				name: 'id_region',
				fieldLabel: 'Administración destino',
				allowBlank: false,
				forceSelection : true,
				emptyText:'Region...',
    ...
    onSubmit: function(o) {
    	...
    	if (me.form.getForm().isValid()) {
			 ...
			 Ext.Ajax.request({
				...
				url:'../../sis_admin/control/Movimiento/reporteCbteEgresos',
				params: parametros,
