...
?>
<script>
Phx.vista.RepResumenSaldosCO=Ext.extend(Phx.frmInterfaz,{
    ...
    {   
        ...
        Phx.vista.RepResumenSaldosCO.superclass.constructor.call(this,config);
        this.init(); 
    ...
    title: 'Reporte de Resumen de Ingresos y Egresos',
    ...
    onSubmit: function(o) {
    	...
    	if (me.form.getForm().isValid()) {
			 ...
			 Ext.Ajax.request({
				...
				url: '../../sis_admin/control/Movimiento/reporteResumenSaldosMensual',
				params:  parametros,
