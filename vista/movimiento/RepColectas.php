...
<script>
Phx.vista.RepColectas=Ext.extend(Phx.frmInterfaz,{
    ...
    {   
        ...
        Phx.vista.RepColectas.superclass.constructor.call(this,config);
        this.init(); 
        this.iniciarEventos();   
    ...
    onSubmit: function(o) {
    	...
    	if (me.form.getForm().isValid()) {
			 ...
			 Ext.Ajax.request({
				...
				url:'../../sis_admin/control/Movimiento/reporteColectas',
				params: parametros,
